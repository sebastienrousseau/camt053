...
rigor for the **camt053** library — a Python library that reads ISO 20022 camt
Bank-to-Customer Cash Management messages (camt.052 Account Report, camt.053
Bank to Customer Statement, camt.054 Debit Credit Notification), extracts booked
entries by return reason code, and generates validated reversing entries.

While camt053 is financial infrastructure software rather than a medical device,
